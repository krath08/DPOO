...
public class RegEmpresa extends JFrame {
	...
	public RegEmpresa(VentanaPrincipal ventanaPrincipal) {
		...
		comboTipoEmpresa = new JComboBox(new String[] { "<Seleccione>", "Turismo", "Salud", "Educacion", "Tecnologia",
				"Construccion", "Comercio", "Industria", "Servicios" });
		...
		btnGuardar.addActionListener(e -> {
			...
			logico.empresa nuevaEmpresa = new logico.empresa(txtId.getText(), txtNombre.getText(),
					logico.TipoEmpresa.valueOf(comboTipoEmpresa.getSelectedItem().toString().toUpperCase()),
					txtDireccion.getText(), txtTelefono.getText(), txtEmail.getText(), fechaRegistro, true, usuario,
					contrasena);
