...
public class RegVacanteEmpresa extends JFrame {
	...
	public RegVacanteEmpresa(empresa empresaActual) {
		this.empresaActual = empresaActual;

		setTitle("Registrar Vacante para " + empresaActual.getNombre());
		...
		comboTipoEmpleo.setBounds(192, 221, 200, 25);
		...
		lblExperiencia.setBounds(30, 269, 150, 25);
		getContentPane().add(lblExperiencia);

		txtExperiencia = new JTextField();
		txtExperiencia.setBounds(192, 270, 60, 25);
		...
		panelRequisitos.setBounds(30, 318, 290, 246);
		...
		lblNewLabel.setIcon(new ImageIcon(RegVacanteEmpresa.class.getResource("/imagen/ImagenRegVacante.png")));
		...
		btnGuardar.addActionListener(e -> {
			try {
				...
				Vacante vacante = new Vacante(id, titulo, descripcion, requisitos, salario, empresaActual, // Asocia la
						// vacante a
						// la
						// empresa
						// logueada
						fechaPublicacion, true, tipoEmpleo, experiencia);
